...
These align with the constraints in the `L2PS-coding` agent (`/workspace/.github/agents/L2PS-coding.md`); honour them and call them out explicitly in the design plan.
