...
![](personal/aiml/study/attachments/2026-06-08_network_structure.png)
...
### 6.4 Epoch 数 vs 准确率
![](personal/aiml/study/attachments/2026-06-08_epoch_experiment.png)
前 5 epoch 收敛最快（53%→88%），15 epoch 后趋于饱和。

### 6.5 Batch Size 的影响
![](personal/aiml/study/attachments/2026-06-08_batch_size_experiment.png)
...
![](personal/aiml/study/attachments/2026-06-08_intra_epoch_loss.png)
...
![](personal/aiml/study/attachments/2026-06-08_confusion_matrix.png)

最自信但答错的样本（置信度 95–99%，多为潦草/连笔/断笔）：
![](personal/aiml/study/attachments/2026-06-08_confident_errors.png)

最犹豫的错误（top1≈top2，决策边界附近）：
![](personal/aiml/study/attachments/2026-06-08_ambiguous_errors.png)
...
![](personal/aiml/study/attachments/2026-06-08_mlp_optimization.png)
...
| 基本 MLP 错误 | 优化 MLP 错误 |
|---|---|
| ![](personal/aiml/study/attachments/2026-06-08_errors_basic_mlp.png) | ![](personal/aiml/study/attachments/2026-06-08_errors_optimized_mlp.png) |
...
![](personal/aiml/study/attachments/2026-06-08_augmentation_examples.png)
...
![](personal/aiml/study/attachments/2026-06-08_augmentation_robustness.png)
...
- [x] 在 `cnn/` 用纯 NumPy 实现 CNN（单块结构），见实验记录：[[2026-06-08 CNN 手写数字识别与实验]]
- [ ] 更深结构冲 **99%+**
- [ ] 参数量 / 推理耗时对比表
- [ ] 与姊妹篇保持双链维护
...
- 姊妹篇（**CNN 专用笔记**）：[[2026-06-08 CNN 手写数字识别与实验]]
